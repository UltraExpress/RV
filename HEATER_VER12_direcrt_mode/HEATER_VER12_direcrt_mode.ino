...
html += "<meta name='viewport' content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no'>";
   ...
   html += "<a href='/control' class='link-btn direct-btn' style='margin-top:12px;display:block;text-align:center;padding:12px;background:#34C759;color:white;border-radius:8px;text-decoration:none;'>Direct Control Mode</a>";
    html += "</div></body></html>";
    server.send(200,"text/html",html);
  }
}
